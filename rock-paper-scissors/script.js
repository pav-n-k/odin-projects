...
function updateViewSelection(playerSelection, computerSelection) {
    ...
    playerResultPicture.setAttribute("src", `./assets/icons/${playerSelection}.svg`);
    computerResultPicture.setAttribute("src", `./assets/icons/${computerSelection}.svg`);
}
...
function runGame() {
    ...
    resetBtn.addEventListener('click', () => {
        ...
        playerResultPicture.setAttribute("src", './assets/icons/question.svg');
        computerResultPicture.setAttribute("src", './assets/icons/question.svg');
    });
};
